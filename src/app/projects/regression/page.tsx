...
const Page: React.FC = () => {
  ...
  return (
    <>
      <section id='regression' className={styles.regression}>
        <div className={styles.regression__container}>
          <PagePosition id='regression-position' actual='Regression' list={LIST} />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            'itemListElement': [
              ...
              { '@type': 'ListItem', 'position': 2, 'name': 'Regre', 'item': 'https://www.inzumer.com/projects/regression' }
            ]
          })
        }}
      />
