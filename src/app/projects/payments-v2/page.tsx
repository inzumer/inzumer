    ...
    <>
      <section id='payments' className={styles.payments}>
        <div className={styles.payments__container}>
          <PagePosition id='payments-position' actual='Payments 2.1' list={LIST} />
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            'itemListElement': [
              ...
              { '@type': 'ListItem', 'position': 2, 'name': 'Payments 2.1', 'item': 'https://www.inzumer.com/projects/payments-v2' }
            ]
          })
        }}
      />
